    ...
    public partial class SqlSyntaxPage
    {
        ...
        public SqlSyntaxPage(SQLContext sqlQuery, BaseSyntaxProvider syntaxProvider)
        {
            ...
            else if (_sqlContext.SyntaxProvider is MySQLSyntaxProvider)
            {
                ...
                else if ((_sqlContext.SyntaxProvider as MySQLSyntaxProvider).ServerVersionInt < 80000)
                {
        ...
        public void ApplyChanges()
        {
            ...
            var oldSyntaxProvider = _sqlContext.SyntaxProvider;

            _sqlContext.SyntaxProvider = _syntaxProvider;

            _sqlContext.SQLGenerationOptionsForServer.QuoteIdentifiers = cbQuoteAllIdentifiers.IsChecked.HasValue && cbQuoteAllIdentifiers.IsChecked.Value ? IdentQuotation.All : IdentQuotation.IfNeed;
