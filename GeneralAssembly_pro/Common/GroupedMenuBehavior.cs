...
{
    public static class GroupedMenuBehavior
    {
        ...
        private static readonly DependencyPropertyKey OptionGroupsPropertyKey =
            DependencyProperty.RegisterAttachedReadOnly("OptionGroups", typeof(Dictionary<string, HashSet<MenuItem>>), typeof(GroupedMenuBehavior), new UIPropertyMetadata(null));
        ...
        static void menuItem_Checked(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var item in @group.Where(item => !Equals(item, menuItem)))
            {
